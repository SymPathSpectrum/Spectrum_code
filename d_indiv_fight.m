tspan = [0 tend];
%   running individual fight in the probiotic ecology
...
eventfunc = @(t,y)d_NutrSteadyState(t,y,r,GamI,GamR,GamP,Degr,kn1,kpi,kpr,kip,krp,kri,kir,E,EP,HCE,nut);
optionsode=odeset('Events',eventfunc,'NonNegative', 1:7);
y0 = [AbI AbR AbP AbTI AbTR AbTP Nu1];
[t,y] = ode45(@(t,y)d_patch_mod(t,y,r,GamI,GamR,GamP,Degr,kn1,kpi,kpr,kip,krp,kri,kir,E,EP,HCE,nut),tspan,y0,optionsode);
K = [t,y];
absI = y(:,1)';
absR = y(:,2)';
absP = y(:,3)';
