function dydt = ot3_freq_patch_mod(t,y,r,GamI,GamR,GamP,Degr,kn1,kpi,kpr,kip,krp,kri,kir,E,EP,HCE)
...
monoTip = y(4)^HCE/((y(4)^HCE)+kip^HCE);    %invader toxin on pathogenF
