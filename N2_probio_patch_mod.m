...
function dydt = N2_probio_patch_mod(t,y,r,GamI,GamR,GamP,Degr,kn1,kpi,kpr,kip,krp,kri,kir,E,EP,HCE,kn2,Ov)
...
dydt(1) = y(1)*(monoN2*r(1)*(1-GamI) + r(1)*(1-GamI)*(Ov*monoN1) - E*monoTri - EP*monoTpi);
...
%I toxin
dydt(4) = GamI*y(1)*monoN2 + GamI*y(1)*Ov*monoN1 - Degr*(y(2)*monoTir + y(3)*monoTip);
