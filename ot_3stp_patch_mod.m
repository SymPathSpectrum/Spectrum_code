function dydt = ot_3stp_patch_mod(t,y,r,GamI,GamR,GamP,Degr,kn1,kpi,kpr,kip,krp,kri,kir,E,EP,HCE)
%GamI/R/P = toxin investment of invader(A), resident(B), path(C)
%Degr = toxin degredation/absorption constant
%E = toxin potency/efficacy
%HCE = hill coefficient
%kn1 = binding affinity for nutrient 1
%Kir = kri  - affinity of toxin binding between resident(B) and invader(A)
